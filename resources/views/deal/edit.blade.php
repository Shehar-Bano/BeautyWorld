            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('deals.update', ['id'=>$deal->id]) }}" method="POST" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" name="name" value="{{$deal->name}}" placeholder="Enter Deal name" required>
                    </div>
                    <div class="form-group">
                        <label for="name">Discount Price</label>
                        <input type="text" class="form-control" id="designation" name="dis_price" value="{{$deal->dis_price}}" placeholder="Enter Discount Price" required>
                    </div>
                    <div class="form-group">
                        <label for="name">Description</label>
                        <input type="textarea" class="form-control" id="description" name="description"  placeholder="Enter Description" value="{{$deal->description}}"required>
                    </div>
                    <div class="form-group">
                        <label for="status">Deal Type</label>
                        <select class="form-control" id="type" name="type" required>
                            <option value="permanent" {{$deal->type == 'permanent' ? 'selected' : ''}}>Permanent</option>
                            <option value="duration"{{$deal->type == 'duration' ? 'selected' : ''}}>Duration</option>
                        </select>
                    </div>
